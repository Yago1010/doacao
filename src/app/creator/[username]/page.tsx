...
import { AboutSection } from "./_components/abount-section";
...
export default async function Apoia({
  ...
  return (
    <div className=" min-h-screen bg-gradient-to-br from-slate-50 via-white-100">
      <CoverSection
      ...
      <main className="container mx-auto max-w-6x1 p-4 sm:p-6 ">
        <div className=" grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 -mt-8 md:-mt-16 z-10 ">
